            ...
            {isToggle && (
                <div className='md:hidden'>
                    <div className="space-y-1 px-2 pb-3">
                        <Link href="/safety" className="block  text-[#415a77] hover:bg-[#FAF9F6] hover:text-[#fefae0] rounded-lg p-2">Recall Checker</Link>
                        <Link href="/availability" className="block text-[#415a77] hover:bg-[#FAF9F6] hover:text-[#fefae0]  rounded-lg p-2">About the Team</Link>
                    </div>
                </div>
            )}
        </div>
